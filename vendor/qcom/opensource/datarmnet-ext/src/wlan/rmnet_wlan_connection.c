...
extern void (*rmnet_wlan_ll_tuple_hook)(struct sk_buff *skb);
...
{
	rcu_assign_pointer(rmnet_wlan_ll_tuple_hook, rmnet_wlan_ll_tuple_match);
...
{
	rcu_assign_pointer(rmnet_wlan_ll_tuple_hook, NULL);
