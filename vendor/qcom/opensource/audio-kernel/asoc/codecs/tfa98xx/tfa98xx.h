...
/* channel configuration, the definition as cnt's index */
#define CHAN_PRI_L    0     /* left_top */
#define CHAN_PRI_R    1     /* right_top */
#define CHAN_SEC_L    2     /* left_bottom */
#define CHAN_SEC_R    3     /* right_bottom */
