...
#define REG_DGDRV             0x81
#define REG_DGCCFG            0x82
#define REG_DGCTM1            0x83
#define REG_DGCTM2            0x84
#define REG_CPWID1            0x85
#define REG_CPWID2            0x86
...
const unsigned char aw20036_reg_access[AW20036_REG_MAX] = {
	...
	[REG_DGDRV] = REG_RD_ACCESS | REG_WR_ACCESS,
	[REG_DGCCFG] = REG_RD_ACCESS | REG_WR_ACCESS,
	[REG_DGCTM1] = REG_RD_ACCESS | REG_WR_ACCESS,
	[REG_DGCTM2] = REG_RD_ACCESS | REG_WR_ACCESS,
	[REG_CPWID1] = REG_RD_ACCESS | REG_WR_ACCESS,
	[REG_CPWID2] = REG_RD_ACCESS | REG_WR_ACCESS,
