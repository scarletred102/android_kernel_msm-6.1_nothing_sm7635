...
_platform_map = {
    ...
    "niobe": {
        ...
        "dtbo_list": [
            ...
            {"name": "niobe-idp-edp-dual-dpu-overlay.dtbo"},
            ...
            {"name": "niobep-idp-edp-dual-dpu-overlay.dtbo"},
...
#            {"name": "cliffs-mtp-peach-overlay.dtbo"},
    ...
    "volcano-tuivm": {
        "dtb_list": [
            ...
            {"name": "volcano6i-vm-mtp-moselle.dtb"},
            {"name": "volcano6i-vm-mtp-moselle-emmc.dtb"},
            ...
            {"name": "volcano6i-vm-mtp-wcd9395-moselle-emmc.dtb"},
            ...
            {"name": "volcano6i-oemvm-mtp-moselle.dtb"},
    ...
    "volcano-oemvm": {
        "dtb_list": [
            ...
            {"name": "volcano6i-oemvm-mtp-ganges.dtb"},
            {"name": "volcano6i-oemvm-mtp-moselle.dtb"},
            {"name": "volcano6i-oemvm-mtp-moselle-emmc.dtb"},
            {"name": "volcano6i-oemvm-mtp-wcd9395-brahma.dtb"},
            {"name": "volcano6i-oemvm-mtp-wcd9395-ganges-hac2019.dtb"},
            {"name": "volcano6i-oemvm-mtp-wcd9395-ganges.dtb"},
            {"name": "volcano6i-oemvm-mtp-wcd9395-moselle.dtb"},
            {"name": "volcano6i-oemvm-mtp-wcd9395-moselle-emmc.dtb"},
            {"name": "volcano-oemvm-qrd.dtb"},
            {"name": "volcano6i-oemvm-qrd-moselle.dtb"},
            {"name": "volcano-vm-atp.dtb"},
            {"name": "volcano-vm-idp.dtb"},
